...
class StudentGroupsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create student_group" do
    assert_difference('StudentGroup.count') do
      post student_groups_url, params: { student_group: { course_name: @student_group.course_name, month: @student_group.month, year: @student_group.year } }
    end
  ...
  test "should update student_group" do
    patch student_group_url(@student_group), params: { student_group: { course_name: @student_group.course_name, month: @student_group.month, year: @student_group.year } }
